...
export default function UserNavbar() {
    ...
    return (
        <nav className="flex items-center justify-between p-4 mb-8 glass-dark rounded-xl border border-gray-800">
            ...
            <div>
                <h2 className="text-xl font-bold bg-gradient-to-r from-green-400 to-teal-500 bg-clip-text text-transparent">
                    My Workspace
                </h2>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-gray-800">
                    ...
                    <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-green-500 to-teal-600 flex items-center justify-center text-white font-bold shadow-lg">
